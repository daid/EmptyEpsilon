...
"""
        ...
        stream.write('<div class="section">')
        stream.write("<h2>Enumerated values</h2>")
        ...
        stream.write('<div class="section">')
        stream.write("<h2>Resource paths</h2>")
        stream.write("<p>Some scripting functions can reference resources, such as other scripts, images, audio files, and 3D models, by a relative path to a file.</p>")
        stream.write("<p>When launched, EmptyEpsilon searches the following directories for the given path.</p>")
        stream.write("<ul>")
        stream.write("<li>If a mod is defined in the preferences file or with the <code>mod</code> command-line option:</li>")
        stream.write("<ul>")
        stream.write("<li>If a <code>$HOME</code> directory is defined:</li>")
        stream.write("<ul>")
        stream.write("<li>~/.emptyepsilon/resources/mods/</li>")
        stream.write("<li>Any resource packs located in ~/.emptyepsilon/resources/mods/</li>")
        stream.write("</ul>")
        stream.write("<li>The resources/mods/ directory relative to the EmptyEpsilon executable</li>")
        stream.write("<li>Any resource packs located in the resources/mods/ directory relative to the EmptyEpsilon executable</li>")
        stream.write("</ul>")
        stream.write("<li>The resources/ directory relative to the EmptyEpsilon executable</li>")
        stream.write("<li>The scripts/ directory relative to the EmptyEpsilon executable</li>")
        stream.write("<li>Any resource packs located in the packs/ directory relative to the EmptyEpsilon executable</li>")
        stream.write("<li>If a <code>$HOME</code> directory is defined:</li>")
        stream.write("<ul>")
        stream.write("<li>~/.emptyepsilon/resources/</li>")
        stream.write("<li>~/.emptyepsilon/scripts/</li>")
        stream.write("<li>Any resource packs located in ~/.emptyepsilon/packs/</li>")
        stream.write("</ul>")
        stream.write("<li>If a <code>RESOURCE_BASE_DIR</code> was defined:</li>")
        stream.write("<ul>")
        stream.write("<li>$RESOURCE_BASE_DIR/resources/</li>")
        stream.write("<li>>$RESOURCE_BASE_DIR/scripts/</li>")
        stream.write("<li>Any resource packs located in >$RESOURCE_BASE_DIR/packs/</li>")
        stream.write("</ul>")
        stream.write("</ul>")
