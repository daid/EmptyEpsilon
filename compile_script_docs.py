...
"""
        ...
        stream.write("<ul>")
        stream.write("<li>If a mod is defined in the preferences file or with the <code>mod</code> command-line option:")
        stream.write("<ul>")
        stream.write("<li>If a <code>$HOME</code> directory is defined:")
        stream.write("<ul>")
        ...
        stream.write("</ul></li>")
        stream.write("<li>If a <code>RESOURCE_BASE_DIR</code> was defined:")
        stream.write("<ul>")
