...
--                  Arc, Dir, Range, CycleTime, Dmg
template:setBeam(0, 40,-5, 1000.0, 6.0, 2)
template:setBeam(1, 40, 5, 1000.0, 6.0, 2)
template:setTubes(2) -- Amount of torpedo tubes
template:setHull(70)
...
template:setTubePosition(1,  10, 2, -2.3)
--                  Arc, Dir, Range, CycleTime, Dmg
template:setBeam(0, 90, -30, 1000.0, 6.0, 2)
template:setBeam(1, 90,  30, 1000.0, 6.0, 2)
template:setBeam(2,100, -60,  800.0, 6.0, 2)
template:setBeam(3,100,  60,  800.0, 6.0, 2)
template:setBeam(4, 30,   0, 1500.0, 6.0, 2)
template:setBeam(5,100, 180,  800.0, 6.0, 2)
template:setTubes(2) -- Amount of torpedo tubes
template:setHull(70)
template:setShields(300, 300)
template:setSpeed(30, 5)
