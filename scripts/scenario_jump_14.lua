...
function init()
	...
	for n=1, 20 do
		setCirclePos(Planet():setPlanetSurfaceTexture("planets/asteroid.png"):setDistanceFromMovementPlane(2000):setPlanetRadius(random(1000, 5000)), 60000, 60000, random(0, 360), random(50000, 60000))
	end
	
	for n=1, 200 do
		setCirclePos(Planet():setPlanetSurfaceTexture("planets/asteroid.png"):setDistanceFromMovementPlane(2000):setPlanetRadius(random(100, 1000)), 60000, 60000, random(0, 360), random(50000, 60000))
	end
