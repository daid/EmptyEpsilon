--- A BlackHole is a piece of space terrain that pulls all nearby SpaceObjects within a 5U radius, including otherwise immobile SpaceObjects like stations, toward its center.
...
--- A WormHole is a piece of space terrain that pulls all nearby SpaceObjects within a 2.5U radius, including otherwise immobile entities like stations, toward its center.
...
--- Defines a function to call when this WormHole teleports an SpaceObject.
