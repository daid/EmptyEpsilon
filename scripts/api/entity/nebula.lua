...
-- function Nebula(radius)
    ...
    -- e.components.radar_trace = {icon="Nebula" .. irandom(1, 3) .. ".png", min_size=16, max_size=nil, radius=radius*1.5, blend_add=true}
    -- e.components.radar_block = {range=radius}
    -- e.components.never_radar_blocked = {}
    -- local render_info = {}
    -- local cloud_count = 32
    -- for n=1,cloud_count do
        -- local size = random(1024, 1024^1.5)
