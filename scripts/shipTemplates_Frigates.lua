...
variation = variation:copy("Phobos M3P"):setLocaleName(_("shipP", "Phobos M3P")):setType("playership")
...
template = ShipTemplate():setName("Hathcock"):setLocaleName(_("shipP", "Hathcock")):setClass(_("class", "Frigate"), _("subclass", "Cruiser: Sniper")):setModel("HeavyCorvetteGreen"):setType("playership")
template:setRadarTrace("radar_piranha.png")
...
variation = template:copy("Piranha"):setLocaleName(_("shipP", "Piranha")):setType("playership")
...
variation = variation:copy("Flavia P.Falcon"):setLocaleName(_("shipP", "Flavia P.Falcon")):setType("playership")
...
template = ShipTemplate():setName("Repulse"):setLocaleName(_("shipP", "Repulse")):setClass(_("class", "Frigate"), _("subclass", "Armored Transport")):setModel("LightCorvetteRed"):setType("playership")
template:setRadarTrace("radar_tug.png")
