function init()
	my_ship = CpuShip():setCommsScript("comms_supply_drop.lua"):setFactionId(faction_id):setPosition(position_x, position_y):setTemplate("Tug"):setScanned(true):orderFlyTowardsBlind(target_x, target_y)
	state = 0
end
