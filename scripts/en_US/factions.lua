neutralFaction = "Independent"
neutralDescription = [[Despite appearing as a faction, independents are distinguished primarily by having no strong affiliation with any faction at all. Most traders consider themselves independent, though certain voices have started to speak up about creating a merchant faction.]]

humanFaction = "Human Navy"
humanDescription = [[The remnants of the human navy.
...
kraylorFaction = "Kraylor"
kraylorDescription = [[The reptilian Kraylor are a race of warriors with a strong religious dogma.
...
arleniansFaction = "Arlenians"
arleniansDescription = [[Arlenians are energy-based life forms who long ago transcended physical reality through superior technology. Arlenians' energy forms also give them access to strong telepathic powers. Many consider Arlenians to be the first and oldest explorers of the galaxy.
...
hiveFaction = "Ktlitans"
hiveDescription = [[The Ktlitans are intelligent eight-legged creatures that resemble Earth's arachnids. However, unlike most terrestrial arachnids, the Ktlitans do not fight among themselves. Their common, and only, goal is their species' survival.
...
tsnFaction = "TSN"
tsnDescription = [[The Terran Stellar Navy or TSN consists of naval forces based near Terra. Its members are primarily Human.
...
usnFaction = "USN"
usnDescription = [[The United Stellar Navy or USN is a naval force near the boundary of Human and Kraylor space consisting of mostly Humans. The USN is friendly with the human navy and uses a similar command structure.
...
cufFaction = "CUF"
cufDescription = [[The Celestial Unified Fleet or CUF is the farthest ranging primarily human fleet as well as the least xenophobic. The CUF goals center primarily on exploration and trade, but since it's a dangerous galaxy, they recognize the need for strong warships. 
