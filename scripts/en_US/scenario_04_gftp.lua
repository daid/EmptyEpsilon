...
function init()
	...
	marco_polo = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCallSign("Marco Polo"):setDescription("A merchant and entertainement hub."):setPosition(-21200, 45250)
	parangon = CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setCallSign("HNS Parangon"):orderDefendTarget(marco_polo):setPosition(-21500, 44500):setScanned(true)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("P-1"):setPosition(-21600, 45000):orderDefendTarget(parangon):setScanned(true)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("P-2"):setPosition(-21000, 44000):orderDefendTarget(parangon):setScanned(true)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("P-3"):setPosition(-22000, 46000):orderDefendTarget(parangon):setScanned(true)
	
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Ksa-1"):setFaction(hiveFaction):setPosition(-43000, 47000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Ksa-2"):setFaction(hiveFaction):setPosition(-43000, 46000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Ksa-3"):setFaction(hiveFaction):setPosition(-43000, 45000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Ksa-4"):setFaction(hiveFaction):setPosition(-43000, 44000):orderRoaming()
	Nebula():setPosition(-42000, 46000)

	--Spawn Stakhanov, its defenders and a Ktilitian assault
	stakhanov = SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCallSign("Stakhanov"):setDescription("The Stakhanov Mining Complex centralises the efforts to mine the material-rich asteroids of the sector."):setPosition(32000, 9000)
	create(Asteroid, 90, 4000, 16000, 32000, 9000)
	create(VisualAsteroid, 70, 4000, 15000, 32000, 9000)
	
	euphrates = CpuShip():setTemplate(piranhaF12):setFaction(humanFaction):setCallSign("HNS Euphrates"):setScanned(true):orderDefendTarget(stakhanov):setPosition(31000, 8500)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setPosition(32500, 8500):orderDefendTarget(euphrates):setScanned(true)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setPosition(32500, 9500):orderDefendTarget(euphrates):setScanned(true)
	
	tigris = CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setCallSign("HNS Tigris"):setScanned(true):orderDefendTarget(stakhanov):setPosition(33000, 9000)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setPosition(31500, 8500):orderDefendTarget(tigris):setScanned(true)
	CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setPosition(31500, 9500):orderDefendTarget(tigris):setScanned(true)
	
	CpuShip():setTemplate("Ktlitan Breaker"):setCallSign("Nleb-1"):setFaction(hiveFaction):setPosition(60000, 7000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Breaker"):setCallSign("Nleb-2"):setFaction(hiveFaction):setPosition(59000, 6000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Breaker"):setCallSign("Nleb-3"):setFaction(hiveFaction):setPosition(58000, 5000):orderAttack(stakhanov)
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Nleb-1A"):setFaction(hiveFaction):setPosition(63000, 8000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Nleb-1B"):setFaction(hiveFaction):setPosition(65000, 9000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Nleb-2A"):setFaction(hiveFaction):setPosition(66000, 10000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Nleb-2B"):setFaction(hiveFaction):setPosition(67000, 11000):orderRoaming()
	
	--Spawn the Black Site and itBLAH BLAH BLAH
	bs114 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCallSign("Black Site #114"):setDescription("A Human Navy secret base. Its purpose is highly classified."):setPosition(-45600, -14800)
	create(Nebula, 4, 10000, 15000, -45600, -14800)
	create(Mine, 8, 5000, 7500, -45600, -14800)
	
	--Spawn the Arlenian Lighbringer
	lightbringer = CpuShip():setTemplate(phobosT3):setCallSign("Lightbringer"):setFaction(arleniansFaction):setPosition(-10000, -20000)
	Nebula():setPosition(-10000, -20000)
	create(Nebula, 2, 4500, 5500, -10000, -20000)
	
	--Spawn diverse things
	nsa = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCallSign("NSA"):setDescription("Nosy Sensing Array, an old SIGINT platform."):setPosition(5000, 5000):setCommsScript("")
	swarm_command = CpuShip():setTemplate("Ktlitan Queen"):setCallSign("Swarm Command"):setFaction(gitmFaction):setPosition(35000, 53000):setCommsFunction(swarmCommandComms)
	d1 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Drone-1"):setFaction(gitmFaction):setPosition(36000, 53000):orderDefendTarget(swarm_command)
	d2 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Drone-2"):setFaction(gitmFaction):setPosition(34000, 53000):orderDefendTarget(swarm_command)
	d3 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Drone-3"):setFaction(gitmFaction):setPosition(35000, 52000):orderDefendTarget(swarm_command)
	d4 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Drone-4"):setFaction(gitmFaction):setPosition(35000, 54000):orderDefendTarget(swarm_command)
	d5 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Drone-5"):setFaction(gitmFaction):setPosition(35500, 53500):orderDefendTarget(swarm_command)
	...
	--Spawn the Player
	player = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setPosition(-22000, 44000):setCallSign("Epsilon")
...
function commsHackedShipCompare(freq_min, freq_max)
	...
	if (freq_min <= frequency)  and (frequency <= freq_max) then
        ...
        addCommsReply("Deploy patch", function()
            comms_target:setFaction(humanFaction)
...
"All Navy ships in the vicinity of the Stakhanov Mining Complex, major Ktlitan reinforcements seems to be en route towards your position, engage the carrier in priority, use extreme caution."]])) then
	...
	CpuShip():setTemplate("Ktlitan Feeder"):setCallSign("Swarm Carrier Zin"):setFaction(hiveFaction):setPosition(53000, 3000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Zin-1"):setFaction(hiveFaction):setPosition(56000, 6000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Zin-2"):setFaction(hiveFaction):setPosition(58000, 8000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Zin-3"):setFaction(hiveFaction):setPosition(59000, 8000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Zin-4"):setFaction(hiveFaction):setPosition(59000, 8000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Zin-5"):setFaction(hiveFaction):setPosition(59000, 8000):orderRoaming()
	mission_timer = 0
	end	
...
"Epsilon, please come in, this is Black Site #114 dispatch relay. We are under heavy assault by a portion of the main Ktlitan fleet ! Location of the base is on a need-to-know basis, so we trust your discreetion."]])) then
	bs114:setFaction(humanFaction)
	korolev = CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setCallSign("HNS Korolev"):setPosition(-45000, -16000):orderDefendTarget(bs114):setScanned(true)
	k1 = CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("K-1"):setPosition(-44000, -15000):orderDefendTarget(bs114):setScanned(true)
	k2 = CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("K-2"):setPosition(-44500, -15500):orderDefendTarget(bs114):setScanned(true)
	k3 = CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("K-3"):setPosition(-46000, -16000):orderDefendTarget(bs114):setScanned(true)
	k4 = CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("K-4"):setPosition(-46500, -16500):orderDefendTarget(bs114):setScanned(true)
	k5 = CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("K-5"):setPosition(-46500, -16500):orderDefendTarget(bs114):setScanned(true)
	
	CpuShip():setTemplate("Ktlitan Breaker"):setCallSign("Flen-1"):setFaction(hiveFaction):setPosition(-51000, -16000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Breaker"):setCallSign("Flen-2"):setFaction(hiveFaction):setPosition(-51000, -17000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Feeder"):setCallSign("Swarm Carrier Flen"):setFaction(hiveFaction):setPosition(-52000, -17000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Flen-1A"):setFaction(hiveFaction):setPosition(-53000, -16000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Flen-1B"):setFaction(hiveFaction):setPosition(-53000, -16500):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Flen-2A"):setFaction(hiveFaction):setPosition(-53000, -17000):orderRoaming()
	CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Flen-2B"):setFaction(hiveFaction):setPosition(-53000, -17500):orderRoaming()
...
"It seems that the enemy is changing its tactics. Our long-range scanners show that a unknown high-velocity ship, escorted by fighters, overrode our internal security. They will try to dock with us, you must intercept it at once !"]])) then
	...
	ghost_hacker = spawnHacker():setCallSign("???"):setFaction(gitmFaction):setPosition(-60000, -14000):orderFlyTowardsBlind(-45000, -14800)
	s1 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Slan-1"):setFaction(hiveFaction):setPosition(-61000, -13000):orderFlyTowards(-45000, -14800)
	s2 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Slan-2"):setFaction(hiveFaction):setPosition(-61000, -14000):orderFlyTowards(-45000, -14800)
	s3 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Slan-3"):setFaction(hiveFaction):setPosition(-61000, -15000):orderFlyTowards(-45000, -14800)
	s4 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Slan-4"):setFaction(hiveFaction):setPosition(-60000, -13000):orderFlyTowards(-45000, -14800)
	s5 = CpuShip():setTemplate("Ktlitan Fighter"):setCallSign("Slan-5"):setFaction(hiveFaction):setPosition(-60000, -15000):orderFlyTowards(-45000, -14800)
...
"'The hell Epsilon ? Fall back immediately to Marco Polo, we send a security detail to extract you. Time to call in the big guns I guess."]])
			...
			korolev:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
			
			if k1:isValid() then
			k1:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
			
			if k2:isValid() then
			k2:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
			
			if k3:isValid() then
			k3:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
			
			if k4:isValid() then
			k4:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
			
			if k5:isValid() then
			k5:setFaction(gitmFaction):setScanned(false):setCommsScript("")
			end
...
To summarize, get near the infected ships, find a backdoor using the frequency LEAST absorbed by their shields and deploy our patches. Godspeed Epsilon."]])
			...
			if korolev:isValid() then
			korolev:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
			
			if k1:isValid() then
			k1:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
			
			if k2:isValid() then
			k2:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
			
			if k3:isValid() then
			k3:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
			
			if k4:isValid() then
			k4:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
			
			if k5:isValid() then
			k5:setFaction(gitmFaction):setScanned(false):setCommsFunction(commsHackedShip)
			end
	...
	expression = ((not korolev:isValid()) or (korolev:getFaction() == humanFaction)) and ((not k1:isValid()) or (k1:getFaction() == humanFaction)) and ((not k2:isValid()) or (k2:getFaction() == humanFaction)) and ((not k3:isValid()) or (k3:getFaction() == humanFaction)) and ((not k4:isValid()) or (k4:getFaction() == humanFaction)) and ((not k5:isValid()) or (k5:getFaction() == humanFaction))
...
We are both ready to continue our purpose, it seems."]])) then
		...
		gfighter1=CpuShip():setTemplate(hornetMT52):setCallSign("Z-1"):setFaction(gitmFaction):setPosition(-20000, -10000):orderFlyTowards(5000, 5000)
		gfighter2=CpuShip():setTemplate(hornetMT52):setCallSign("Z-2"):setFaction(gitmFaction):setPosition(-20000, -10000):orderFlyTowards(5000, 5000)
		gfighter3=CpuShip():setTemplate(hornetMT52):setCallSign("Z-3"):setFaction(gitmFaction):setPosition(-20000, -11000):orderFlyTowards(5000, 5000)
		gfighter4=CpuShip():setTemplate(hornetMT52):setCallSign("Z-4"):setFaction(gitmFaction):setPosition(-20000, -11000):orderFlyTowards(5000, 5000)
...
"We have the command platform location confirmed in the nebula around H6. All Navy ships, converge on the location. We advise you to deploy probes near the pointed nebula for a better visibility."]])) then
		...
		scout = spawnHacker():setFaction(humanFaction):setCallSign("Recovery Team"):setPosition(35500, 43000):setScanned(true)
		main_mission = 11
		end	
		...
		shiva = spawnNuker():setCallSign("HNS Shiva"):setFaction(humanFaction):setPosition(2000, 2000):orderFlyTowards(-44600, -13800):setScanned(true)
		...
		CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("S-1"):setPosition(3000, 3000):orderDefendTarget(shiva):setScanned(true)
		CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("S-2"):setPosition(1000, 1000):orderDefendTarget(shiva):setScanned(true)
		CpuShip():setTemplate(hornetMT52):setFaction(humanFaction):setCallSign("S-3"):setPosition(3000, 1000):orderDefendTarget(shiva):setScanned(true)
		main_mission = 11
		end
	end
	...
	if (main_mission == 12) then
		if (hacked == 0) then
			...
			mission_time = 0
			main_mission = 13
			CpuShip():setTemplate(hornetMT52):setFaction(gitmFaction):setCallSign("Z-1"):setPosition(40000, 53000):orderAttack(scout)
			CpuShip():setTemplate(hornetMT52):setFaction(gitmFaction):setCallSign("Z-2"):setPosition(40000, 53500):orderAttack(scout)
			CpuShip():setTemplate(hornetMT52):setFaction(gitmFaction):setCallSign("Z-3"):setPosition(40000, 52500):orderAttack(scout)
			puShip():setTemplate(hornetMT52):setFaction(gitmFaction):setCallSign("Z-3"):setPosition(40000, 52500):orderAttack(scout)
			end
...
function spawnNuker()
    ship = CpuShip():setTemplate(phobosT3)
    ship:setHullMax(100):setHull(100)
