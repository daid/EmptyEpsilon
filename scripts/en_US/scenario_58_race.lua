...
function setStations()
	...
	friendlyStations = 0
	neutralStations = 0
	stationTimer = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationVaiken = SpaceStation():setTemplate(hugeStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationZefram = SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationMarconi = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationMudd = SpaceStation():setTemplate(mediumStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationAlcaleica = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationCalifornia = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationOutpost15 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationOutpost21 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationValero = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationVactel = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationArcher = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationDeer = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationCavor = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationEmory = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationVeloquan = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationBarclay = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationLipkin = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationRipley = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationDeckard = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationConnor = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationAnderson = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationFeynman = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationMayo = SpaceStation():setTemplate(largeStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationNefatha = SpaceStation():setTemplate(mediumStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationScience4 = SpaceStation():setTemplate(mediumStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationSpeculation4 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationTiberius = SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationResearch11 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationFreena = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationOutpost33 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationLando = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationKomov = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationScience2 = SpaceStation():setTemplate(mediumStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationPrefect = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationOutpost7 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationOrgana = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationGrap = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationGrup = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationOutpost8 = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationScience7 = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationCarradine = SpaceStation():setTemplate(smallStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationCalvin = SpaceStation():setTemplate(mediumStation):setFaction(neutralFaction):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationGanalda = SpaceStation():setTemplate(mediumStation):setFaction(kraylorFaction)
	...
	stationEmpok = SpaceStation():setTemplate(largeStation):setFaction(exuariFaction)
	...
	stationTic = SpaceStation():setTemplate(mediumStation):setFaction(kraylorFaction)
...
function spawnTargetDrone(originx,originy,targetDroneID,area,sequenceNumber)
	if shootBack then
		enemyTemplate = atlantisX23
	else
		enemyTemplate = "Fighter"
	end
	tdx, tdy = vectorFromAngle(random(0,360),random(2500,4800))
	td = CpuShip():setTemplate(enemyTemplate):setPosition(originx+tdx,originy+tdy):setFaction(kraylorFaction)
					...
					if chasers then
						if not p5.chaser then
							if p5.laps == 1 then
								...
								p5.c1 = CpuShip():setTemplate(stalkerQ7):setPosition(racePoint1x+cx,racePoint1y+cy)
								p5.c1:setFaction(kraylorFaction):orderAttack(p5)
								cx, cy = vectorFromAngle(raceAxis,random(5000,8000))
								p5.c2 = CpuShip():setTemplate(stalkerR7):setPosition(racePoint1x+cx,racePoint1y+cy)
								p5.c2:setFaction(kraylorFaction):orderAttack(p5)
								cx, cy = vectorFromAngle(raceAxis,random(1000,3000))
								p5.c3 = CpuShip():setTemplate(piranhaF12):setPosition(racePoint1x+cx,racePoint1y+cy)
								p5.c3:setFaction(kraylorFaction):orderDefendLocation(racePoint1x,racePoint1y)						
							end
						end
					end
					if p5.goal == 2 then
