...
-- Starcaller
template = ShipTemplate():setName("Comet Class Scout"):setClass("Comet", "Scout"):setModel("space_tug")
...
template = ShipTemplate():setName("Luna Class Cargo Carrier"):setClass("Luna", "Carrier"):setModel("space_tug")
...
template = ShipTemplate():setName("Aurora Class Landing Craft"):setClass("Aurora", "Landing Craft"):setModel("space_tug")
template:setRadarTrace("eoc_carrier.png")
template:setHull(300)
template:setShields(500, 500, 500, 500)
template:setSpeed(70, 5, 5)
template:setBeam(0, 30, 0, 1000.0, 2.0, 10)
template:setWarpSpeed(0)
template:setJumpDrive(false)
...
-- Space station
template = ShipTemplate():setName("Medium station"):setModel("space_station_1"):setLocaleName(_("Medium Station")):setType("station")
