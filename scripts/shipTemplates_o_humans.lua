...
-- Fighter
template = ShipTemplate():setName("Fighter F975"):setClass("Starfighter", "Interceptor"):setModel("WespeScoutYellow")
...
template = ShipTemplate():setName("Scoutship S342"):setClass("Frigate", "Cruiser"):setModel("space_frigate_6")
...
template = ShipTemplate():setName("Scoutship S835"):setClass("Frigate", "Cruiser"):setModel("small_frigate_1")
template:setRadarTrace("radar_cruiser")
...
template = ShipTemplate():setName("Cargoship T842"):setClass("Frigate", "Cruiser"):setModel("small_frigate_2")
template:setRadarTrace("radar_cruiser")
template:setHull(70)
template:setShields(50, 40)
template:setSpeed(15, 5, 5)
...
-- Cruiser
template = ShipTemplate():setName("Cruiser C753"):setClass("Corvette", "Destroyer"):setModel("small_frigate_3")
