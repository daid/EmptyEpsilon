-- Name: Vagues
-- Description: Des vagues d'ennemis de plus en plus difficiles.
-- Type: Basic
-- Variation[Facile]: Rend chaque vague plus facile en diminuant le nombre de vaisseaux. (Il faut plus de temps pour que les joueurs soient d�pass�s ; Recommand� pour les �quipages d�butants).
-- Variation[Difficile]: Commence � la vague 5 et augmente la difficult� de 1,5 apr�s chaque vague. (Les joueurs sont plus rapidement d�bord�s, ce qui entra�ne des parties plus courtes).
