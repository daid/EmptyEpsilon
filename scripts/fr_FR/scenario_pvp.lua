...
function init()
	...
	-- Stations
	shangri_la = SpaceStation():setPosition(10000, 10000):setTemplate(largeStation):setFaction(neutralFaction):setRotation(random(0, 360)):setCallSign("Shangri-La"):setCommsFunction(shangrilaComms)

	human_shipyard = SpaceStation():setPosition(-7500, 15000):setTemplate(smallStation):setFaction(humanFaction):setRotation(random(0, 360)):setCallSign("Mobile Shipyard"):setCommsFunction(stationComms)
	CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setPosition(-8000, 16500):orderDefendTarget(human_shipyard):setScannedByFaction(humanFaction, true)
	CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setPosition(-6000, 13500):orderDefendTarget(human_shipyard):setScannedByFaction(humanFaction, true)
	CpuShip():setTemplate(phobosT3):setFaction(humanFaction):setPosition(-7000, 14000):orderDefendTarget(human_shipyard):setScannedByFaction(humanFaction, true)
	CpuShip():setTemplate(nirvanaR5):setFaction(humanFaction):setPosition(-8000, 14000):orderDefendTarget(human_shipyard):setScannedByFaction(humanFaction, true)

	kraylor_shipyard = SpaceStation():setPosition(27500, 5000):setTemplate(smallStation):setFaction(kraylorFaction):setRotation(random(0, 360)):setCallSign("Forward Command"):setCommsFunction(stationComms)
	CpuShip():setTemplate(phobosT3):setFaction(kraylorFaction):setPosition(29000, 5000):orderDefendTarget(kraylor_shipyard):setScannedByFaction(kraylorFaction, true)
	CpuShip():setTemplate(phobosT3):setFaction(kraylorFaction):setPosition(25000, 5000):orderDefendTarget(kraylor_shipyard):setScannedByFaction(kraylorFaction, true)
	CpuShip():setTemplate(phobosT3):setFaction(kraylorFaction):setPosition(27500, 6000):orderDefendTarget(kraylor_shipyard):setScannedByFaction(kraylorFaction, true)
	CpuShip():setTemplate(nirvanaR5):setFaction(kraylorFaction):setPosition(27000, 5000):orderDefendTarget(kraylor_shipyard):setScannedByFaction(kraylorFaction, true)

	-- Spawn players
	gallipoli = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setPosition(-8500, 15000):setCallSign("HNS Gallipoli"):setScannedByFaction(kraylorFaction, false)
	crusader = PlayerSpaceship():setFaction(kraylorFaction):setTemplate(atlantis):setPosition(26500, 5000):setCallSign("Crusader Naa'Tvek"):setScannedByFaction(humanFaction, false)
...
Support our glorious soldiers by preventing the heretics from harming our transports, and cleanse all enemy opposition!]])
	...
	human_transport = spawnTransport():setFaction(humanFaction):setPosition(-7000, 15000):orderDock(shangri_la):setScannedByFaction(humanFaction, true)
	table.insert(humanTroops, human_transport)
	CpuShip():setTemplate('MT52 Hornet'):setFaction(humanFaction):setPosition(-7000, 15500):orderDefendTarget(human_transport):setScannedByFaction(humanFaction, true)
	CpuShip():setTemplate('MT52 Hornet'):setFaction(humanFaction):setPosition(-7000, 14500):orderDefendTarget(human_transport):setScannedByFaction(humanFaction, true)
	
	kraylor_transport = spawnTransport():setFaction(kraylorFaction):setPosition(26500, 5000):orderDock(shangri_la):setScannedByFaction(kraylorFaction, true)
	table.insert(kraylorTroops, kraylor_transport)
	CpuShip():setTemplate('MT52 Hornet'):setFaction(kraylorFaction):setPosition(26500, 5500):orderDefendTarget(kraylor_transport):setScannedByFaction(kraylorFaction, true)
	CpuShip():setTemplate('MT52 Hornet'):setFaction(kraylorFaction):setPosition(26500, 4500):orderDefendTarget(kraylor_transport):setScannedByFaction(kraylorFaction, true)
end
...
function stationComms()
	...
	if comms_source:isFriendly(comms_target) then
		...
		addCommsReply("Send in more troops. (100 reputation)", function()
			...
			if comms_target:getFaction() == kraylorFaction then
			  kraylor_transport = spawnTransport():setFaction(kraylorFaction):setPosition(comms_target:getPosition()):orderDock(shangri_la):setScannedByFaction(kraylorFaction, true)
				table.insert(kraylorTroops, kraylor_transport)
				...
				human_transport = spawnTransport():setFaction(humanFaction):setPosition(comms_target:getPosition()):orderDock(shangri_la):setScannedByFaction(humanFaction, true)
				table.insert(humanTroops, human_transport)
		...
		addCommsReply("We need some space-based firepower. (150 reputation)", function()
			...
			strike_leader = CpuShip():setTemplate(phobosT3):setFaction(comms_target:getFaction()):setPosition(comms_target:getPosition()):orderDefendTarget(shangri_la):setScannedByFaction(comms_source:getFaction(), true)
...
function update(delta)
	...
	if (not gallipoli:isValid()) then
		...
		if human_respawn > 20 then
			gallipoli = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setPosition(-8500, 15000):setCallSign("HNS Heinlein"):setScannedByFaction(kraylorFaction, false)
	...
	if (not crusader:isValid()) then
		if kraylor_respawn > 20 then
			crusader = PlayerSpaceship():setFaction(kraylorFaction):setTemplate(atlantis):setPosition(19000, -14500):setCallSign("Crusader Elak'raan"):setScannedByFaction(humanFaction, false)
		else
...
With the Kraylor flagship out of the way, we can land the final blow!]])
	...
	if wave_timer > 150 and (human_shipyard:isValid()) then
		...
		human_transport = spawnTransport():setFaction(humanFaction):setPosition(-7000, 5000 + line):orderDock(shangri_la):setScannedByFaction(humanFaction, true)
		table.insert(humanTroops, human_transport)
		CpuShip():setTemplate('MT52 Hornet'):setFaction(humanFaction):setPosition(-7000, 5500 + line):orderDefendTarget(human_transport):setScannedByFaction(humanFaction, true)
		CpuShip():setTemplate('MT52 Hornet'):setFaction(humanFaction):setPosition(-7000, 4500 + line):orderDefendTarget(human_transport):setScannedByFaction(humanFaction, true)
	
		line = random(0, 20) * 500
		kraylor_transport = spawnTransport():setFaction(kraylorFaction):setPosition(27000, -5000 + line):orderDock(shangri_la):setScannedByFaction(kraylorFaction, true)
		table.insert(kraylorTroops, kraylor_transport)
		CpuShip():setTemplate('MT52 Hornet'):setFaction(kraylorFaction):setPosition(27000, -5500 + line):orderDefendTarget(kraylor_transport):setScannedByFaction(kraylorFaction, true)
		CpuShip():setTemplate('MT52 Hornet'):setFaction(kraylorFaction):setPosition(27000, -4500 + line):orderDefendTarget(kraylor_transport):setScannedByFaction(kraylorFaction, true)
