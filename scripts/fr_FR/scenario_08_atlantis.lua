...
function init()
    ...
    player = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis)
    ...
    --Starting area
    shipyard_gamma = SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCallSign("Shipyard-Gamma"):setPosition(25276, 134550)
    ...
    supply_station_6 = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCallSign("Supply-6"):setPosition(14491, 126412)
    ...
    CpuShip():setFaction(humanFaction):setTemplate(phobosT3):setCallSign("D-2"):setScanned(true):setPosition(12419, 124184):orderDefendTarget(supply_station_6):setCommsScript("")
    CpuShip():setFaction(humanFaction):setTemplate(phobosT3):setCallSign("D-3"):setScanned(true):setPosition(16104, 127943):orderDefendTarget(supply_station_6):setCommsScript("")
    ...
    transport_f1 = CpuShip():setFaction(humanFaction):setTemplate(flavia):setCallSign("F-1"):setScanned(true):setPosition(28521, 114945):orderIdle()
    transport_f1:setCommsScript("")

    target_dummy_1 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("Dummy-1"):setPosition(29269, 109499):orderIdle():setRotation(random(0, 360))
    target_dummy_2 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("Dummy-2"):setPosition(31032, 109822):orderIdle():setRotation(random(0, 360))
    ...
    jc88 = CpuShip():setFaction(humanFaction):setTemplate(jumpCarrier):setCallSign("JC-88"):setScanned(true):setPosition(18972, 135882):orderIdle()
    jc88:setCommsFunction(jc88Comms)

    --Sector B20
    CpuShip():setFaction(kraylorFaction):setTemplate(lindwormWX):setCallSign("S11"):setPosition(304666, -75558):orderDefendLocation(304666, -75558):setWeaponStorage(homing, 0):setWeaponStorage(hvli, 4)
    CpuShip():setFaction(kraylorFaction):setTemplate(hornetMU52):setCallSign("S10"):setPosition(306010, -74718):orderDefendLocation(306010, -74718)
    CpuShip():setFaction(kraylorFaction):setTemplate("Adder MK5"):setCallSign("CCN8"):setPosition(304364, -74222):orderDefendLocation(304364, -74222):setWeaponStorage(hvli, 3)
    b20_nebula_list = {}
...
Doppler instability: %i]], b20_artifact.beta_radiation, b20_artifact.gravity_disruption, b20_artifact.ionic_phase_shift, b20_artifact.doppler_instability))
    ...
    x, y = table.remove(b20_nebula_list, math.random(#b20_nebula_list)):getPosition()
    CpuShip():setFaction(gitmFaction):setPosition(x + random(-1000, 1000), y + random(-1000, 1000)):setTemplate(phobosT3):orderDefendLocation(x, y)

    x, y = table.remove(b20_nebula_list, math.random(#b20_nebula_list)):getPosition()
    CpuShip():setFaction(gitmFaction):setPosition(x + random(-1000, 1000), y + random(-1000, 1000)):setTemplate(piranhaF12):orderDefendLocation(x, y)

    x, y = table.remove(b20_nebula_list, math.random(#b20_nebula_list)):getPosition()
    CpuShip():setFaction(gitmFaction):setPosition(x + random(-1000, 1000), y + random(-1000, 1000)):setTemplate(starhammerII):orderDefendLocation(x, y)
    
    --kraylor defense line.
    kraylor_defense_line = {
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(7657, -264940),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(9915, -289620),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(1822, -287037),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-6615, -285401),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-18324, -283593),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-24522, -276878),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-28138, -268613),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-23403, -256302),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-11608, -254149),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(46849, -260262),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(35571, -254924),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(22312, -254063),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(10842, -255239),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(65015, -272745),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(60452, -263189),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(56664, -280494),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(48829, -284454),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(22915, -287381),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(36690, -287554),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(-34202, -259093),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(29547, -294816),
        WarpJammer():setFaction(kraylorFaction):setRange(18000):setPosition(54372, -255958)
    }
    ...
    for _, warp_jammer in ipairs(kraylor_defense_line) do
        ...
        ship = CpuShip():setFaction(kraylorFaction):setPosition(x + random(-1000, 1000), y + random(-1000, 1000)):orderDefendLocation(x, y)
        if random(0, 100) < 20 then
            ship:setTemplate(defensePlateform)
        elseif random(0, 100) < 50 then
            ship:setTemplate(atlantisX23)
        else
            ship:setTemplate(starhammerII)
        end
        table.insert(kraylor_defense_line_ships, ship)
        for n=1,3 do
            ship2 = CpuShip():setFaction(kraylorFaction):setPosition(x + random(-1000, 1000), y + random(-1000, 1000)):orderDefendTarget(ship)
            if random(0, 100) < 50 then
                ship2:setTemplate(phobosT3)
            elseif random(0, 100) < 20 then
                ship2:setTemplate(piranhaF12M)
            else
                ship2:setTemplate(piranhaF12)
            end
            table.insert(kraylor_defense_line_ships, ship2)
        end
    end

    SpaceStation():setTemplate(hugeStation):setFaction(kraylorFaction):setPosition(32099, -291152)
    SpaceStation():setTemplate(hugeStation):setFaction(kraylorFaction):setPosition(-4252, -297462)
    SpaceStation():setTemplate(hugeStation):setFaction(kraylorFaction):setPosition(-27984, -262071)

    kraylor_forward_line = {
        SpaceStation():setTemplate(smallStation):setFaction(kraylorFaction):setPosition(-7278, -197898),
        SpaceStation():setTemplate(largeStation):setFaction(kraylorFaction):setPosition(-13839, -233328),
        SpaceStation():setTemplate(largeStation):setFaction(kraylorFaction):setPosition(29333, -240151),
        SpaceStation():setTemplate(smallStation):setFaction(kraylorFaction):setPosition(36681, -200260)
    }
...
Head to sector K6, there is a supply drop there dropped by F-1. Pick this up to stock up on missile weapons.]])
    supply_drop = SupplyDrop():setFaction(humanFaction):setPosition(29021, 114945):setEnergy(500):setWeaponStorage(homing, 12):setWeaponStorage(nuke, 4):setWeaponStorage(mine, 8):setWeaponStorage(emp, 6):setWeaponStorage(hvli, 20)
...
However, do NOT engage any of the Kraylor bases directly. You are not equipped to handle a full on assault.]])
        kraylor_transport = CpuShip():setFaction(kraylorFaction):setTemplate(flavia):setCallSign("KHVT"):orderIdle()
...
function phase4DestroyTheTransport(delta)
    ...
    elseif kraylor_transport.drop == nil then
        ...
        putKraylorDefenseLineOnFullOffense()
        kraylor_transport.drop = SupplyDrop():setFaction(humanFaction):setPosition(kraylor_transport.x, kraylor_transport.y)
...
All hands on deck. Man all stations, evacuate! Save what you can!]])
        odin = CpuShip():setFaction(kraylorFaction):setTemplate(odin):setCallSign(odin):setScanned(true):setPosition(26900, 132872):orderAttack(shipyard_gamma)
