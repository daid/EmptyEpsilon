...
function init()
	--SpaceStation():setPosition(1000, 1000):setTemplate(smallStation):setFaction(humanFaction):setRotation(random(0, 360))
	--SpaceStation():setPosition(-1000, 1000):setTemplate(mediumStation):setFaction(humanFaction):setRotation(random(0, 360))
	--SpaceStation():setPosition(1000, -1000):setTemplate(largeStation):setFaction(humanFaction):setRotation(random(0, 360))
	--SpaceStation():setPosition(-1000, -1000):setTemplate(hugeStation):setFaction(humanFaction):setRotation(random(0, 360))
	--player1 = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setRotation(200)
    --player2 = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setRotation(0)
    ...
    --CpuShip():setTemplate("Adder MK5"):setPosition(0, 0):setRotation(0):setFaction(humanFaction)
    --CpuShip():setTemplate(piranhaF12):setPosition(2000, 0):setRotation(-90):setFaction(kraylorFaction)
