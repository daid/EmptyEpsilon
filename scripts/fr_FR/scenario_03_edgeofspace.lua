...
function init()
    ...
    Player = PlayerSpaceship():setFaction(humanFaction):setTemplate(atlantis):setPosition(12400, 18200):setCallSign("Apollo"):addReputationPoints(250.0)
    ...
    Technical_Officer = CpuShip():setFaction(humanFaction):setTemplate(flavia):setCallSign("Technical Officer"):setPosition(1530000,411000):orderIdle()
	...
	Nirvana = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setPosition(1530000,412000):setCallSign("Nirvana")

    EOS_Station = SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setPosition(60500, 42100):setCallSign("E.O.S Scope")
    EOS_Station:setCommsScript("") -- Disable the comms script for the EOS Scope station.
	Midspace_Station = SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setPosition(34643, 39301):setCallSign("Midspace Support")
	Central_Command = SpaceStation():setTemplate(hugeStation):setFaction(humanFaction):setPosition(14500, 19100):setCallSign("Central Command")
    Central_Command:setCommsScript("comms_station_scenario_03_central_command.lua")
    
	Kraylor_Eline = SpaceStation():setTemplate(smallStation):setFaction(kraylorFaction):setPosition(79200, 38800):setCallSign("K-Endline")
	Kraylor_Mline = SpaceStation():setTemplate(largeStation):setFaction(kraylorFaction):setPosition(101830, 26725):setCallSign("K-Midline")
	
	Science_Galileo = SpaceStation():setTemplate(mediumStation):setFaction(arleniansFaction):setPosition(11100, -49150):setCallSign("Galileo")
	
	-------------------------------------------------------------------------
	--Random-ass stations
	SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCallSign("DS7"):setPosition(-44177, 20762)
	SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCallSign("DS4"):setPosition(1632, 30619)
	SpaceStation():setTemplate(smallStation):setFaction(humanFaction):setCallSign("DS3"):setPosition(-9130, 10285)
	SpaceStation():setTemplate(mediumStation):setFaction(humanFaction):setCallSign("DS2"):setPosition(-27987, 41095)
	---------------------------------------------------------------------------
	
	Human_m1 = CpuShip():setFaction(humanFaction):setTemplate(hornetMT52):setCallSign("HM1"):setScanned(true):setPosition(31875, 38653):orderDefendLocation(31875, 38653)
    Human_m2 = CpuShip():setFaction(humanFaction):setTemplate(hornetMT52):setCallSign("HM2"):setScanned(true):setPosition(37493, 37185):orderDefendLocation(37493, 37185)
    Human_m3 = CpuShip():setFaction(humanFaction):setTemplate(hornetMT52):setCallSign("HM3"):setScanned(true):setPosition(35519, 42854):orderDefendLocation(35519, 42854)
	...
	kraylor_e1 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setPosition(80200, 39900):setCallSign("K-EC1"):orderStandGround()
	kraylor_e2 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setPosition(78200, 38000):setCallSign("K-EC2"):orderStandGround()
	kraylor_e3 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setPosition(78000, 37100):setCallSign("K-EF1"):orderStandGround()
	kraylor_e4 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setPosition(80200, 37900):setCallSign("K-EF2"):orderStandGround()
	
	--Kraylor ships primed to attack Galileo
	kraylor_g1 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setScanned(true):setCallSign("K-Strike1"):setPosition(6273, -55399):orderIdle()
    kraylor_g2 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setScanned(true):setCallSign("K-Fi2"):setPosition(10922, -51749):orderIdle()
    kraylor_g3 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setScanned(true):setCallSign("K-Fi3"):setPosition(13948, -52838):orderIdle()
	
	--Kraylor Midline ships protecting Mline
	kraylor_m1 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("K-MF1"):setPosition(103710, 31493):orderStandGround()
    kraylor_m2 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("K-MF2"):setPosition(97993, 22149):orderStandGround()
    kraylor_m3 = CpuShip():setFaction(kraylorFaction):setTemplate(atlantisX23):setCallSign("K-MDFD"):setPosition(106363, 25218):orderStandGround()
    kraylor_m4 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("K-MC001"):setPosition(104829, 21454):orderStandGround()
    ...
    CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("K-SCN1"):setPosition(90940, -32988):orderDefendLocation(90940, -32988)
    CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("K-SCN2"):setPosition(95243, -29693):orderDefendLocation(95243, -29693)
    CpuShip():setFaction(kraylorFaction):setTemplate(atlantisX23):setCallSign("K-GDN1"):setPosition(105057, -46060):orderDefendLocation(105057, -46060)
    CpuShip():setFaction(kraylorFaction):setTemplate(atlantisX23):setCallSign("K-GDN2"):setPosition(102474, -42231):orderDefendLocation(102474, -42231)
    CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("K-EGF1"):setPosition(87826, -3182):orderDefendLocation(87826, -3182)
...
Please dock so we can come aboard.]])
	...
	if Central_Command.mission_state == 10 then
		if distance(Player, Kraylor_hole) < 10000 then
			...
			k01 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("BR21"):setPosition(-50654, 32238):orderRoaming()
			k02 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("UT64"):setPosition(-48368, 27476):orderRoaming()
			k03 = CpuShip():setFaction(kraylorFaction):setTemplate(phobosT3):setCallSign("NC13"):setPosition(-34082, 40047):orderRoaming()
			k04 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("CV45"):setPosition(-59606, 18904):orderRoaming()
			k05 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("TI25"):setPosition(-43796, 43857):orderRoaming()
			k06 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("IN16"):setPosition(-43796, 52428):orderRoaming()
			k07 = CpuShip():setFaction(kraylorFaction):setTemplate(piranhaF12):setCallSign("VA27"):setPosition(-58082, 31285):orderRoaming()
			k08 = CpuShip():setFaction(kraylorFaction):setTemplate(piranhaF12):setCallSign("CN78"):setPosition(-26082, 22333):orderRoaming()
			k09 = CpuShip():setFaction(kraylorFaction):setTemplate(atlantisX23):setCallSign("AL92"):setPosition(-42273, 12238):orderRoaming()
			k10 = CpuShip():setFaction(kraylorFaction):setTemplate(starhammerII):setCallSign("OH30"):setPosition(-26844, 48809):orderRoaming()
			k11 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("SS11"):setPosition(-45320, 9381):orderRoaming()
			k12 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("CS61"):setPosition(-40558, 8809):orderRoaming()
			k13 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("JL33"):setPosition(-27796, 52428):orderRoaming()
			k14 = CpuShip():setFaction(kraylorFaction):setTemplate(hornetMT52):setCallSign("SQ50"):setPosition(-24368, 46143):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("BN53"):setPosition(-40654, 47095):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("VK68"):setPosition(-37796, 56619):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("XD37"):setPosition(-29987, 55476):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("CC31"):setPosition(-45796, 26143):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("CM29"):setPosition(-51892, 24047):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("SO40"):setPosition(-2939, 40619):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("VS41"):setPosition(2966, 45000):orderRoaming()
			--CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("BR42"):setPosition(-12796, 16809):orderRoaming()
			--CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(hornetMT52):setCallSign("UTI43"):setPosition(-10463, 7476):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(phobosT3):setCallSign("CI44"):setPosition(-10368, 13571):orderRoaming()
			CpuShip():setFaction(humanFaction):setScanned(true):setTemplate(phobosT3):setCallSign("NI15"):setPosition(-10368, 50143):orderRoaming()
