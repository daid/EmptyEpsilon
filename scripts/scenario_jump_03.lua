...
-- Station
	...
	-- EOC Starfleet		
		aurora = CpuShip():setFaction("EOC Starfleet"):setTemplate("Battlecruiser B952"):setPosition(x + random(20000, 40000), y + random(-40000, -20000)):setRotation(-75):setScannedByFaction("Corporate owned"):setCanBeDestroyed(false)
		...
		inferno = CpuShip():setFaction("EOC Starfleet"):setTemplate("Cruiser C753"):setPosition(x + random(20000, 40000), y + random(-40000, -20000)):orderFlyFormation(flagship, -6000, 1000):setScannedByFaction("Corporate owned"):setCanBeDestroyed(false)
	...
	-- Civilians
		...
		centurion = CpuShip():setFaction("Corporate owned"):setTemplate("Cruiser C243"):setPosition(x + random(20000, 40000), y + random(-40000, -20000)):orderFlyFormation(flagship, -7000, 4000):setScannedByFaction("Corporate owned", true):setScannedByFaction("Faith of the High Science", true):setScannedByFaction("Government owned", true):setScannedByFaction("Unregistered", true):setCanBeDestroyed(false) 
