...
model:addTubePosition( 10, 2, -2.3)
model:addEngineEmitter(-2.1500, -13, 0.3,  0.2, 0.2, 1.0, 3.0)
model:addEngineEmitter( 2.1500, -13, 0.3,  0.2, 0.2, 1.0, 3.0)
...
model = ModelData()
model:setName("AdlerLongRangeScout")
model:setMesh("AdlerLongRangeScout/AdlerLongRangeSoutHull.model")
model:setTexture("AdlerLongRangeScout/AlbedoAO/AdlerLongRangeScoutYellowAlbedoAO.png")
...
model = ModelData()
model:setName("AtlasHeavyFighter")
model:setMesh("AtlasHeavyFighter/AtlasHeavyFighterHull.model")
model:setTexture("AtlasHeavyFighter/AlbedoAO/AtlasHeavyFighterYellowAlbedoAO.png")
...
model = ModelData()
model:setName("LindwurmFighter")
model:setMesh("LindwurmFighter/LindwurmFighterHull.model")
model:setTexture("LindwurmFighter/AlbedoAO/LindwurmFighterYellowAlbedoAO.png")
...
model = ModelData()
model:setName("WespeScout")
model:setMesh("WespeScout/WespeScoutHull.model")
model:setTexture("WespeScout/AlbedoAO/WespeScoutYellowAlbedoAO.png")
