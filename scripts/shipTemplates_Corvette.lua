...
variation = template:copy("Atlantis"):setLocaleName(_("shipP", "Atlantis")):setType("playership")
...
template = ShipTemplate():setName("Crucible"):setLocaleName(_("shipP", "Crucible")):setClass(_("class", "Corvette"), _("subclass", "Popper")):setModel("LaserCorvetteRed"):setType("playership")
...
template = ShipTemplate():setName("Maverick"):setLocaleName(_("shipP", "Maverick")):setClass(_("class", "Corvette"), _("subclass", "Gunner")):setModel("LaserCorvetteGreen"):setType("playership")
...
variation = template:copy("Benedict"):setLocaleName(_("shipP", "Benedict")):setType("playership"):setClass(_("class", "Corvette"), _("subclass", "Freighter/Carrier"))
...
var2 = variation:copy("Kiriya"):setLocaleName(_("shipP", "Kiriya"))
