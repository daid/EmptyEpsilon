...
-- Station
 planet1 = Planet():setPosition(50000, 25000):setPlanetSurfaceTexture("planets/TE49-HE75.png"):setPlanetRadius(35000)
...
function wave_one()
	...
	-- Cruisers 60
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-40000, -25000), y + random(25000, 40000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-40000, -25000), y + random(40000, 65000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-65000, -40000), y + random(25000, 40000)):orderRoaming(x, y)
        end
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-40000, -25000), y + random(40000, 65000)):orderRoaming(x, y)
        end
		...
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(-65000, -40000), y + random(25000, 40000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(-40000, -25000), y + random(25000, 40000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(-40000, -25000), y + random(40000, 65000)):orderRoaming(x, y)
        end
