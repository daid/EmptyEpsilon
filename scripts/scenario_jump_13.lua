...
function wave_one()
	...
	-- Cruisers 35
		...
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-45000, 40000), y + random(-40000, -25000)):orderRoaming(x, y)
        end
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(-40000, 25000), y + random(-65000, -40000)):orderRoaming(x, y)
        end
		...
		for n=1,10 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(-45000, 40000), y + random(-40000, -25000)):orderRoaming(x, y)
        end
