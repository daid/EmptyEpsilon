...
template = ShipTemplate():setName("Adder MK4"):setClass("Starfighter", "Gunship"):setModel("AdlerLongRangeScoutYellow")
...
template:setHull(40)
template:setShields(20)
template:setSpeed(60, 20, 20)
template:setDefaultAI('fighter')
template:setBeam(0, 35, -0, 1200, 6.0, 2.0)
template:setBeam(1, 70, 30, 1000, 6.0, 2.0)
template:setBeam(2, 70, -35, 1000, 6.0, 2.0)
...
template = ShipTemplate():setName("Adder MK6"):setClass("Starfighter", "Gunship"):setModel("AdlerLongRangeScoutYellow")
