...
var2 = variation:copy("Adder MK3"):setLocaleName(_("Adder MK3"))
...
var2 = variation:copy("Adder MK7"):setLocaleName(_("Adder MK7"))
...
variation = template:copy("Adder MK8"):setLocaleName(_("Adder MK8"))
...
variation = template:copy("Adder MK9"):setLocaleName(_("Adder MK9"))
variation:setModel("AdlerLongRangeScoutRed")
