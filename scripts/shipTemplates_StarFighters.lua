...
variation = variation:copy("MP52 Hornet"):setLocaleName(_("shipP", "MP52 Hornet")):setType("playership")
...
variation = template:copy("ZX-Lindworm"):setLocaleName(_("shipP", "ZX-Lindworm")):setModel("LindwurmFighterBlue"):setType("playership")
