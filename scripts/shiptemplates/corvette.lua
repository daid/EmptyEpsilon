...
template:setDescription("The Saipan mixes most of the strengths of the corvette with carrier capability. The weapons compare favorably with other corvette class ships. Having fighters use the Saipan as a base can really ruin an enemy's day")
...
template:setRestocksMissilesDocked(true)	--applies to docking CPUShips only
--                  Arc, Dir,  Range, CycleTime, Dmg
