...
template:setDescription(_([[The Exuari fighter 'Dagger' is a very quick and agile single-seated spacecraft that doesn't deal much damage, but usually attacks in large groups. They can dodge most missiles and attack undefended areas of their enemies' ships. However, most Exuari fighter pilots expect their own death and don't care much about their enemies' weapons ranges. Fighters are easy to take out but shouldn't be underestimated.]]))
...
variation:setDescription(_([[The Exuari interceptor 'Blade' is a improved fighter originally designed to hunt rogue fighters. Blades are now often encountered as the first attack wave of a larger assault, closely followed by Daggers. Blade pilots are often considered to be as fearless, but most of them are just consumed by their instinct for hunting.]]))
...
template:setModel("small_fighter_1")
template:setRadarTrace("exuari_fighter.png")
template:setDescription(_([[The Exuari light bomber 'Gunner' is a single-seated spacecraft designed to circumvent their enemies' defensive lines and bring its deadly load to bear on slow-moving targets. Gunners aren't as agile as other fighters but are still faster than most capital ships. A group of Gunners can do a lot of damage to a single stationary target if not destroyed before their target is inside their weapons range. Piloting a Gunner is considered to be a recreational, and often lethal, activity within Exuari society, so don't expect experienced pilots.]]))
template:setBeam(0, 60, 0, 1000.0, 4.0, 4)
template:setHull(40)
template:setShields(30)
--Reputation Score: 7
...
variation:setDescription(_([[The Exuari bomber 'Shooter' carries two rounds of HVLIs. To keep the vessel's costs low, it has no automatic missile recharge system, so the single pilot must manually load the second round. Shooter pilots tend to stay on the battlefield even without ammunition and enjoy spreading death. Due to its long reload cycle, a Shooter can be easily destroyed between its attack runs.]]))
...
variation:setDescription(_([[The Exuari heavy bomber 'Jagger' carries a single round of improved armor-penetrating HVLIs that can deal multiple times the damage of a Gunner's HVLIs.]]))
...
template:setDescription(_([[The Exuari alpha striker 'Racer' is a warp drive-equipped fighter built for quick strikes. This spacecraft runs on a small crew and is often used as a scout, interceptor, or preemptive attacker. It's fast and agile, but the striker's beams don't deal an extreme amount of damage. Like all strikers, it lacks in rear shields.]]))
--                  Arc, Dir, Range, CycleTime, Dmg
...
variation:setDescription(_([[The Exuari beta striker 'Hunter' is a warp drive-equipped reinforcement fighter. This spacecraft runs on a small crew and often supports other Exuari ships engaged in combat. It has an extra pair of striker beams and improved front shields. It's fast, agile, and can clean up what's left of the enemy's fleet after an initial strike.]]))
...
variation:setDescription(_([[The Exuari gamma striker 'Strike' is a warp drive-equipped tactical bomber built for quick strikes against heavily shielded targets. This spacecraft runs on a small crew and is equipped with HVLIs and an EMP. It's fast, agile, and can do a great amount of damage in a short time.]]))
...
variation:setDescription(_([[The Exuari delta striker 'Dash' is a warp drive-equipped endurance bomber built for prolonged strikes. This spacecraft runs on a small crew and combines reinforced front shields with a large stock of HVLIs. It's fast, agile, and can take some damage.]]))
...
template:setDescription(_([[The Exuari Guard is an unimpressive ship that attempts to be an all-around escort or defense vessel. Its insufficient reactor causes the reload cycle of its beams and missiles to take longer than expected. The Guard is equipped with turreted beams and a large stock of different missile types, including homing missiles and mines.]]))
template:setHull(70)
...
template:setDescription(_([[The Exuari Sentinel is an anti-fighter frigate with several rapid-firing, low-damage point-defense turret beams to quickly take out starfighters.]]))
...
template:setDescription(_([[The Exuari Warden is a heavy artillery frigate that fires barrages of missiles from forward-facing tubes. It has only a single point-defense beam turret.]]))
...
template:setDescription(_([[The Exuari Flash is a special artillery sniper built to deal large amounts of damage quickly and from distance before escaping. Its hull is that of a basic freighter loaded with nuclear weapons. Rumors suggest that freighters captured by the Exuari are refitted into Flash vessels.]]))
template:setHull(30)
...
variation:setDescription(_([[The Exuari Ranger is a special sniper, built to deal a large amount of damage over a large area and from a distance before escaping. It's a basic frigate that carries nuclear weapons, even though it's also one of the smallest of all frigate-class ships.]]))
...
variation:setDescription(_([[The Exuari Buster is a special sniper built to deal a large amount of damage quickly and from a distance before escaping. Despite being a basic frigate design and one of the smallest of all frigate-class ships, it's armed with a nuclear warhead.]]))
variation:setTubes(1, 15.0)
variation:setTubeSize(0, "large")
...
template:setDescription(_([[The Exuari 'Ryder' is a large carrier spacecraft with many defensive features, a slow impulse drive, and interstellar flight, allowing it to function like a mobile space station. Smaller ships can dock with it to refuel or be carried, whether externally or within its hangar bay. It's also used to house Exuari crews.

A commom Exuari assault strategy is to keep a Ryder out of a target's sensor range while it launches fighters and artillery.]]))
--                  Arc, Dir, Range, CycleTime, Dmg
...
variation:setDescription(_([[The Exuari Fortress is a huge carrier with many defensive features and a slow impulse drive, allowing it to function like a mobile space station. Smaller ships can dock with it to refuel or be carried, whether externally or within its hangar bay. This mobile base's shields are rumored to be invincible.]]))
--                  Arc, Dir, Range, CycleTime, Dmg
