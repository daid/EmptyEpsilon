...
-- Description: Race three laps of four waypoints (1 to 2 to 3 to 4 to 1 = 1 lap) in the shortest time. 
---
...
function setStations()
	...
	friendlyStations = 0
	neutralStations = 0
	stationTimer = SpaceStation():setTemplate("Small Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationVaiken = SpaceStation():setTemplate("Huge Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationZefram = SpaceStation():setTemplate("Medium Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationCalifornia = SpaceStation():setTemplate("Small Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationEmory = SpaceStation():setTemplate("Small Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationFeynman = SpaceStation():setTemplate("Small Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationMayo = SpaceStation():setTemplate("Large Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationTiberius = SpaceStation():setTemplate("Medium Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	neutralStations = neutralStations + 1
	stationScience7 = SpaceStation():setTemplate("Small Station"):setFaction("EOC Starfleet"):setCommsScript(""):setCommsFunction(commsStation)
	...
	stationGanalda = SpaceStation():setTemplate("Medium Station"):setFaction("Machines")
	...
	stationTic = SpaceStation():setTemplate("Medium Station"):setFaction("Machines")
...
function spawnTargetDrone(originx,originy,targetDroneID,area,sequenceNumber)
	...
	td = CpuShip():setTemplate(enemyTemplate):setPosition(originx+tdx,originy+tdy):setFaction("Machines")
			...
			if player ~= nil and player:isValid() then
				if not player.nameAssigned then
					...
					elseif tempPlayerType == "Player Missile Cr." then
						...
						player:addReputationPoints(5)
						incrementPlayerGoods("food")
					elseif tempPlayerType == "Fighter F967" then
					...
					if chasers then
						if not p5.chaser then
							if p5.laps == 1 then
								...
								p5.c1:setFaction("Machines"):orderAttack(p5)
								cx, cy = vectorFromAngle(raceAxis,random(5000,8000))
								p5.c2 = CpuShip():setTemplate("Stalker R7"):setPosition(racePoint1x+cx,racePoint1y+cy)
								p5.c2:setFaction("Machines"):orderAttack(p5)
								...
								p5.c3:setFaction("Machines"):orderDefendLocation(racePoint1x,racePoint1y)						
							end
						end
					end
					if p5.goal == 2 then
