...
-- Mine ship -- 
variation = template:copy("Nautilus"):setType("playership"):setClass(frigate, mineLayer)
...
template = ShipTemplate():setName("Missile Cruiser"):setModel("space_cruiser_4"):setClass(frigate, cruiser .. " : " .. popper)
template:setRadarTrace("radar_missile_cruiser.png")
...
template = ShipTemplate():setName("Strikeship"):setModel("small_frigate_3"):setClass(starfighter, strikeShip)
...
template = ShipTemplate():setName("Battlestation"):setModel("space_station_2"):setClass(dreadnaught, cruiser)
