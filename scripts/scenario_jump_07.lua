...
-- Station
 planet1 = Planet():setPosition(70000, -25000):setPlanetSurfaceTexture("planets/CA95-LN71.png"):setPlanetRadius(30000)
...
-- Civilians
	...
	polaris = CpuShip():setFaction("Corporate owned"):setTemplate("Cruiser C243"):setPosition(x + random(-80000, -50000), y + random(-80000, -50000)):orderFlyFormation(flagship, -4000, 7000):setScannedByFaction("Corporate owned", true):setScannedByFaction("Faith of the High Science", true):setScannedByFaction("Government owned", true):setScannedByFaction("Unregistered", true):setCallSign("ESS Polaris"):setScannedByFaction("EOC Starfleet", true):setCanBeDestroyed(false)
...
function changeScenarioPrep()
	...
	removeGMFunction("Change scenario to 07")
