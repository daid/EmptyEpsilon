...
function wave_one()
	...
	-- Cruisers 60
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(30000, 70000), y + random(-50000, -10000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(20000, 70000), y + random(-60000, -20000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(40000, 70000), y + random(-60000, -20000)):orderRoaming(x, y)
        end
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(20000, 70000), y + random(-60000, -20000)):orderRoaming(x, y)
        end
		...
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(20000, 70000), y + random(-60000, -20000)):orderRoaming(x, y)
        end
		
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Cruiser"):setPosition(x + random(40000, 70000), y + random(-60000, -10000)):orderRoaming(x, y)
        end
...
function wave_two()
	...
	-- Cruisers 60
		for n=1,20 do
			CpuShip():setFaction("Machines"):setTemplate("Machine Fighter"):setPosition(x + random(40000, 70000), y + random(-60000, -10000)):orderRoaming(x, y)
        end
