...
{  // this list includes all Hotkeys and their standard configuration
    ...
    newKey("INC_IMPULSE", "Increase impulse", "Up");
    newKey("DEC_IMPULSE", "Decrease impulse", "Down");
    newKey("ZERO_IMPULSE", "Zero impulse", "Space");
    newKey("MAX_IMPULSE", "Max impulse", "");
    newKey("MIN_IMPULSE", "Max reverse impulse", "");
    newKey("TURN_LEFT", "Turn left", "Left");
    newKey("TURN_RIGHT", "Turn right", "Right");
    newKey("WARP_0", "Warp off", "");
    newKey("WARP_1", "Warp 1", "");
    newKey("WARP_2", "Warp 2", "");
    newKey("WARP_3", "Warp 3", "");
    newKey("WARP_4", "Warp 4", "");
    newKey("DOCK_ACTION", "Dock request/abort/undock", "D");
    newKey("DOCK_REQUEST", "Initiate docking", "");
    newKey("DOCK_ABORT", "Abort docking", "");
    newKey("UNDOCK", "Undock", "D");
    ...
    newKey("SELECT_MISSILE_TYPE_HOMING", "Select homing", "Num1");
    newKey("SELECT_MISSILE_TYPE_NUKE", "Select nuke", "Num2");
    newKey("SELECT_MISSILE_TYPE_MINE", "Select mine", "Num3");
    newKey("SELECT_MISSILE_TYPE_EMP", "Select EMP", "Num4");
    newKey("SELECT_MISSILE_TYPE_HVLI", "Select HVLI", "Num5");
    for(int n=0; n<max_weapon_tubes; n++)
        newKey(std::string("LOAD_TUBE_") + string(n+1), std::string("Load tube ") + string(n+1), "");
    for(int n=0; n<max_weapon_tubes; n++)
        newKey(std::string("UNLOAD_TUBE_") + string(n+1), std::string("Unload tube ") + string(n+1), "");
    for(int n=0; n<max_weapon_tubes; n++)
        newKey(std::string("FIRE_TUBE_") + string(n+1), std::string("Fire tube ") + string(n+1), "");
    newKey("NEXT_ENEMY_TARGET", "Select next target", "");
    newKey("NEXT_TARGET", "Select next target (any)", "");
    newKey("TOGGLE_SHIELDS", "Toggle shields", "S");
    ...
    newKey("SELECT_REACTOR", "Select reactor system", "Num1");
    newKey("SELECT_BEAM_WEAPONS", "Select beam weapon system", "Num2");
    newKey("SELECT_MISSILE_SYSTEM", "Select missile weapon system", "Num3");
    newKey("SELECT_MANEUVER", "Select maneuvering system", "Num4");
    newKey("SELECT_IMPULSE", "Select impulse system", "Num5");
    newKey("SELECT_WARP", "Select warp system", "Num6");
    newKey("SELECT_JUMP_DRIVE", "Select jump drive system", "Num7");
    newKey("SELECT_FRONT_SHIELDS", "Select front shields system", "Num8");
    newKey("SELECT_REAR_SHIELDS", "Select rear shields system", "Num9");
    newKey("INCREASE_POWER", "Increase system power", "Up");
    newKey("DECREASE_POWER", "Decrease system power", "Down");
    newKey("INCREASE_COOLANT", "Increase system coolant", "Right");
    newKey("DECREASE_COOLANT", "Decrease system coolant", "Left");
    ...
    newKey("STATION_HELMS", "Switch to helms station", "F2");
    newKey("STATION_WEAPONS", "Switch to weapons station", "F3");
    newKey("STATION_ENGINEERING", "Switch to engineering station", "F4");
    newKey("STATION_SCIENCE", "Switch to science station", "F5");
    newKey("STATION_RELAY", "Switch to relay station", "F6");
