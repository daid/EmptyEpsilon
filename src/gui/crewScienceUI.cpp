...
void CrewScienceUI::onCrewUI()
{
    ...
    if (drawToggleButton(sf::FloatRect(20, 770, 200, 50), science_show_radar, "Radar", 30))
        science_show_radar = true;

    if (drawToggleButton(sf::FloatRect(20, 820, 200, 50), !science_show_radar, "Database", 30))
    {
