    ...
    case CMD_OPEN_TEXT_COMM:
        if (comms_state == CS_Inactive || comms_state == CS_BeingHailed || comms_state == CS_BeingHailedByGM || comms_state == CS_ChannelClosed)
        {
            ...
            if (comms_target)
            {
                ...
                comms_incomming_message = tr("shiplog", "Opened comms with ") + comms_target_name;
        ...
        if (comms_state == CS_BeingHailed)
        {
            ...
            if (playerShip)
            {
                if (anwser)
                {
                    ...
                    comms_incomming_message = tr("shiplog", "Opened comms to ") + playerShip->getCallSign();
                    playerShip->comms_incomming_message = tr("shiplog", "Opened comms to ") + getCallSign();
