...
public:
    ...
    //TODO: color by ffi/faction

    bool operator!=(const RadarTrace& o)
    {
        return icon != o.icon || min_size != o.min_size || max_size != o.max_size || radius != o.radius || color != o.color || rotate != o.rotate;
    }
};
static inline sp::io::DataBuffer& operator << (sp::io::DataBuffer& packet, const RadarTrace& rt) { return packet << rt.icon << rt.min_size << rt.max_size << rt.radius << rt.color << rt.rotate; }
static inline sp::io::DataBuffer& operator >> (sp::io::DataBuffer& packet, RadarTrace& rt) { return packet >> rt.icon >> rt.min_size >> rt.max_size >> rt.radius >> rt.color >> rt.rotate; }
