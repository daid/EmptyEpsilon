...
void ParticleEngine::render()
{
    ...
    ShaderManager::getShader("shaders/billboardShader")->setUniform("textureMap", *textureManager.getTexture("particle.png"));
    sf::Shader::bind(ShaderManager::getShader("shaders/billboardShader"));
    glBegin(GL_QUADS);
