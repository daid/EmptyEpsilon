...
int main(int argc, char** argv)
{
    ...
    string lang = "en_US";
    if(PreferencesManager::get("lang") != "")
    {
        lang = PreferencesManager::get("lang");
    }
    ...
    new DirectoryResourceProvider(RESOURCE_BASE_DIR "scripts/" + lang + "/");
    ...
    if (getenv("HOME"))
    {
        ...
        new DirectoryResourceProvider(string(getenv("HOME")) + "/.emptyepsilon/scripts/" + lang + "/");
        new DirectoryResourceProvider(string(getenv("HOME")) + "/.emptyepsilon/packs/SolCommand/");
    }
    
    std::ofstream ofs;
    ofs.open ("scripts/options.lua", std::ofstream::out | std::ofstream::trunc);
    ofs << "-- This code was auto-generated by your application. \n";
    ofs << "-- Manual changes to this file may cause unexpected behavior in your application. \n";
    ofs << "-- Manual changes to this file will be overwritten if the code is regenerated. \n";
    ofs << "lang = \"" + lang + "\"";
    ofs.close();

    new DirectoryResourceProvider("resources/");
    new DirectoryResourceProvider("scripts/");
    new DirectoryResourceProvider("scripts/" + lang + "/");
