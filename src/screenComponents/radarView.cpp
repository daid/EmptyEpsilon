...
: GuiElement(owner, id), next_ghost_dot_update(0.0), targets(targets), missile_tube_controls(nullptr), distance(distance), target_spaceship(targetSpaceship), long_range(false), show_ghost_dots(false)
