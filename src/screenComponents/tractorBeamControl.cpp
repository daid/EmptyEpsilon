...
GuiTractorBeamControl::GuiTractorBeamControl(GuiContainer* owner, string id): GuiAutoLayout(owner, id, GuiAutoLayout::LayoutVerticalColumns){
    ...
    lateralPanel = new GuiAutoLayout(this, "LATERAL_PANEL", GuiAutoLayout::LayoutVerticalTopToBottom);
    ...
    radar = new GuiRadarView(this, "TACTICAL_RADAR", 2000.0, nullptr, my_spaceship);
    radar->setSize(GuiElement::GuiSizeMax, BEAM_PANEL_HEIGHT);
    radar->setPosition(0, 0, ATopRight);
