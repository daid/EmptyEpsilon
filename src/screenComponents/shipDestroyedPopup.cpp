...
: GuiElement(owner, "SHIP_DESTROYED_POPUP"), owner(owner)
{
    ...
    (new GuiLabel(frame, "SHIP_DESTROYED_TEXT", gettext("SHIP DESTROYED!"), 70))->setPosition(0, -25, ACenter)->setSize(0, 0);
    (new GuiButton(frame, "SHIP_DESTROYED_BUTTON", gettext("Return"), [this]() {
