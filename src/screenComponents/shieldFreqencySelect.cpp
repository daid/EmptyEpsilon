...
: GuiBox(owner, id)
{
    (new GuiLabel(this, id + "_CURRENT_LABEL", gettext("Active Shield Freq."), 30))->setPosition(0, 20, ATopLeft)->setSize(GuiElement::GuiSizeMax, 30);
    ...
    (new GuiLabel(this, id + "_CHANGE_LABEL", gettext("Change Shield Freq."), 30))->setPosition(0, 120, ATopLeft)->setSize(GuiElement::GuiSizeMax, 30);
    ...
    calibrate_button = new GuiButton(this, id + "_CHANGE_BUTTON", gettext("Calibrate"), [this]() {
        if (my_spaceship)
