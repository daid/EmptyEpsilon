...
: GuiElement(owner, id)
{
    button = new GuiButton(this, id + "_BUTTON", gettext("Shields: ON"), []() {
        if (my_spaceship)
    ...
    (new GuiLabel(bar, id + "_CALIBRATING_LABEL", gettext("Calibrating"), 30))->setSize(GuiElement::GuiSizeMax, GuiElement::GuiSizeMax);
