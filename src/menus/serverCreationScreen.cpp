...
ServerCreationScreen::ServerCreationScreen()
{
    ...
    (new GuiLabel(this, "SCENARIO_LABEL", gettext("Scenario"), 30))->addBox()->setPosition(-50, 50, ATopRight)->setSize(460, 50);
    ...
    float y = 50;
    (new GuiLabel(this, "GENERAL_LABEL", gettext("General"), 30))->addBox()->setPosition(50, y, ATopLeft)->setSize(550, 50);
    y += 50;
    (new GuiTextEntry(this, "SERVER_NAME", game_server->getServerName()))->setPosition(300, y, ATopLeft)->setSize(300, 50);
    (new GuiLabel(this, "NAME_LABEL", gettext("Server name:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    ...
    (new GuiLabel(this, "IP_LABEL", gettext("Server IP:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    (new GuiBox(this, "IP_BOX"))->setPosition(50, y, ATopLeft)->setSize(550, 50);

    y += 70;
    (new GuiLabel(this, "PLAYER_SHIP_LABEL", gettext("Player ships"), 30))->addBox()->setPosition(50, y, ATopLeft)->setSize(550, 50);
    y += 50;
    ...
    }))->setOptions({gettext("Ship default"), gettext("Warp-drive"), gettext("Jump-drive"), gettext("Both")})->setSelectionIndex((int)gameGlobalInfo->player_warp_jump_drive_setting)->setPosition(300, y, ATopLeft)->setSize(300, 50);
    (new GuiLabel(this, "WARP_JUMP_LABEL", gettext("Warp/Jump:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    ...
    (new GuiLabel(this, "RADAR_LABEL", gettext("Radar range:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    (new GuiBox(this, "RADAR_BOX"))->setPosition(50, y, ATopLeft)->setSize(550, 50);

    y += 70;
    (new GuiLabel(this, "MAIN_SCREEN_LABEL", gettext("Main screen"), 30))->addBox()->setPosition(50, y, ATopLeft)->setSize(550, 50);
    y += 50;
    ...
    (new GuiLabel(this, "MAIN_TACTICLE_LABEL", gettext("Tactical radar:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    ...
    (new GuiLabel(this, "MAIN_LONG_RANGE_LABEL", gettext("Long range radar:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    (new GuiBox(this, "MAIN_LONG_RANGE_BOX"))->setPosition(50, y, ATopLeft)->setSize(550, 50);

    y += 70;
    (new GuiLabel(this, "GAME_RULES_LABEL", gettext("Game rules"), 30))->addBox()->setPosition(50, y, ATopLeft)->setSize(550, 50);
    y += 50;
    ...
    (new GuiLabel(this, "GAME_FREQUENCIES_LABEL", gettext("Frequencies:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    ...
    (new GuiLabel(this, "GAME_SYS_DAMAGE_LABEL", gettext("System damage:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    (new GuiBox(this, "GAME_SYS_DAMAGE_BOX"))->setPosition(50, y, ATopLeft)->setSize(550, 50);
    y += 50;
    (new GuiLabel(this, "GAME_SCANNING_COMPLEXITY_LABEL", gettext("Science scanning:"), 30))->setAlignment(ACenterRight)->setPosition(50, y, ATopLeft)->setSize(250, 50);
    ...
    }))->setOptions({gettext("None (delay)"), gettext("Simple"), gettext("Normal"), gettext("Advanced")})->setSelectionIndex((int)gameGlobalInfo->scanning_complexity)->setPosition(300, y, ATopLeft)->setSize(300, 50);

    (new GuiButton(this, "CLOSE_SERVER", gettext("Close server"), [this]() {
        destroy();
        disconnectFromServer();
        returnToMainMenu();
    }))->setPosition(150, -50, ABottomLeft)->setSize(300, 50);
    (new GuiButton(this, "START_SERVER", gettext("Start"), [this]() {
        startScenario();
