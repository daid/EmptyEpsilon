...
: GuiOverlay(owner, "SINGLEPILOT_SCREEN", sf::Color::Black)
{
    ...
    energy_display = new GuiKeyValueDisplay(left_panel, "ENERGY_DISPLAY", 0.45, gettext("Energy"), "");
    energy_display->setTextSize(20)->setPosition(-20, -140, ABottomRight)->setSize(240, 40);
    heading_display = new GuiKeyValueDisplay(left_panel, "HEADING_DISPLAY", 0.45, gettext("Heading"), "");
    heading_display->setTextSize(20)->setPosition(-20, -100, ABottomRight)->setSize(240, 40);
    velocity_display = new GuiKeyValueDisplay(left_panel, "VELOCITY_DISPLAY", 0.45, gettext("Speed"), "");
    velocity_display->setTextSize(20)->setPosition(-20, -60, ABottomRight)->setSize(240, 40);
    shields_display = new GuiKeyValueDisplay(left_panel, "SHIELDS_DISPLAY", 0.45, gettext("Shields"), "");
    ...
    lock_aim = new GuiToggleButton(left_panel, "LOCK_AIM", gettext("Lock"), nullptr);
