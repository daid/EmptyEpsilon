...
: GuiOverlay(owner, "HELMS_SCREEN", colorConfig.background)
{
    ...
    radar->setRangeIndicatorStepSize(10000.0)->shortRange()->enableGhostDots()->enableWaypoints()->enableCallsigns()->enableHeadingIndicators()->setStyle(GuiRadarView::Circular);
