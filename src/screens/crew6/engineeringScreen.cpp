...
: GuiOverlay(owner, "ENGINEERING_SCREEN", sf::Color::Black), selected_system(SYS_Reactor)
{
    ...
    hull_display = new GuiKeyValueDisplay(this, "HULL_DISPLAY", 0.45, gettext("Hull"), "");
    ...
    (new GuiLabel(box, "POWER_LABEL", gettext("Power"), 30))->setVertical()->setAlignment(ACenterLeft)->setPosition(20, 20, ATopLeft)->setSize(30, 360);
    (new GuiLabel(box, "COOLANT_LABEL", gettext("Coolant"), 30))->setVertical()->setAlignment(ACenterLeft)->setPosition(110, 20, ATopLeft)->setSize(30, 360);
