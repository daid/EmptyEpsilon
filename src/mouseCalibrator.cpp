...
{
    text(sf::FloatRect(0, 100, getWindowSize().x, 300), "Touch Calibration", AlignCenter, 50);
    
    switch(state)
    {
    case 0:
        box(sf::FloatRect(50, 50, 50, 50));
        ...
        break;
    case 1:
        box(sf::FloatRect(getWindowSize().x - 100, 50, 50, 50));
        if (InputHandler::mouseIsReleased(sf::Mouse::Left))
        {
        ...
        break;
    case 2:
        box(sf::FloatRect(50, getWindowSize().y - 100, 50, 50));
        if (InputHandler::mouseIsReleased(sf::Mouse::Left))
        {
    ...
    
    {
        ...
        text(sf::FloatRect(0, 300, getWindowSize().x, 300), string(pos.x) + " " + string(pos.y), AlignCenter, 50);
    }
}
